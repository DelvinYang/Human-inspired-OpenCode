...
run_step "$PYTHON_BIN" code/scripts/datasets/ind/build_ind_demo.py --config "$DATASET_CONFIG" --clean
run_step "$PYTHON_BIN" code/scripts/experiments/train_demo.py --config "$SCRATCH_CONFIG" --clean
run_step "$PYTHON_BIN" code/scripts/evaluation/evaluate_demo.py --config "$SCRATCH_CONFIG"

run_step "$PYTHON_BIN" code/scripts/experiments/train_demo_transfer.py --config "$TRANSFER_CONFIG" --clean
run_step "$PYTHON_BIN" code/scripts/evaluation/evaluate_demo_transfer.py --config "$TRANSFER_CONFIG"

rm -rf "$EVAL_ROOT"
mkdir -p "$EVAL_ROOT"
run_step "$PYTHON_BIN" code/scripts/evaluation/evaluate_model.py \
...
run_step "$R_BIN" code/scripts/visualization/plot_longtail_case_demo.R
