...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=Path, default=Path("configs/experiments/demo_evaluate_ind_pretrained.yaml"))
...
def main() -> None:
    ...
    payload = {
        ...
        "out_dir": str(resolve(config.get("out_dir", "artifacts/demo_ind_pretrained_eval"))),
